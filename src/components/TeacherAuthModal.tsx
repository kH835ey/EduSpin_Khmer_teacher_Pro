    ...
    try {
      ...
      if (user) {
        ...
        if (teacherSnap.exists()) {
          ...
          await safeSetDoc(teacherDocRef, teacherData);
        }
              ...
              {activeSubModal === 'email' && (
                <form onSubmit={handleEmailAuthSubmit} className="space-y-3.5">
                  ...
                  <motion.button
                    ...
                    className="relative w-full py-3 rounded-full font-black text-sm text-white bg-gradient-to-b from-indigo-500 via-indigo-600 to-indigo-800 border border-white/40 shadow-[0_6px_20px_rgba(79,70,229,0.45),inset_0_2px_3px_rgba(255,255,255,0.85),inset_0_-2px_4px_rgba(0,0,0,0.4)] backdrop-blur-md cursor-pointer overflow-hidden group select-none disabled:opacity-50 mt-2 flex items-center justify-center gap-2"
                  >
                    <div className="absolute top-0 inset-x-2 h-[48%] bg-gradient-to-b from-white/75 via-white/25 to-transparent rounded-t-full pointer-events-none" />
                    <motion.div
                      animate={{ x: ['-100%', '100%'] }}
                      transition={{ repeat: Infinity, duration: 2.6, ease: "easeInOut" }}
                      className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent pointer-events-none"
                    />
                    {isLoading ? <Loader2 className="w-4 h-4 animate-spin text-white relative z-10" /> : <Mail className="w-4 h-4 text-white relative z-10 drop-shadow-xs" />}
                    <span className="relative z-10 drop-shadow-xs">{isLoading ? 'កំពុងភ្ជាប់អ៊ីមែល...' : 'ចូលប្រើប្រាស់ជាមួយ Email'}</span>
                  </motion.button>
              ...
              {activeSubModal === 'google' && (
                <form onSubmit={handleGoogleDirectSubmit} className="space-y-3.5">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.92, scaleY: 0.88, scaleX: 1.06 }}
                    transition={{ type: "spring", stiffness: 500, damping: 20 }}
                    className="relative w-full py-3 rounded-full font-black text-sm text-slate-800 bg-gradient-to-b from-slate-50 via-white to-slate-100 border border-slate-300 shadow-[0_6px_20px_rgba(0,0,0,0.1),inset_0_2px_3px_rgba(255,255,255,0.9),inset_0_-2px_4px_rgba(0,0,0,0.05)] backdrop-blur-md cursor-pointer overflow-hidden group select-none disabled:opacity-50 mt-2 flex items-center justify-center gap-2"
                  >
                    <div className="absolute top-0 inset-x-2 h-[48%] bg-gradient-to-b from-white/95 via-white/40 to-transparent rounded-t-full pointer-events-none" />
                    <motion.div
                      animate={{ x: ['-100%', '100%'] }}
                      transition={{ repeat: Infinity, duration: 2.8, ease: "easeInOut" }}
                      className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent pointer-events-none"
                    />
                    {isLoading ? <Loader2 className="w-4 h-4 animate-spin text-slate-700 relative z-10" /> : <GoogleIcon />}
                    <span className="relative z-10 drop-shadow-xs">{isLoading ? 'កំពុងភ្ជាប់ Google Account...' : 'ចូលប្រើប្រាស់ជាមួយ Google Account'}</span>
                  </motion.button>
              ...
              {activeSubModal === 'facebook' && (
                <form onSubmit={handleFacebookDirectSubmit} className="space-y-3.5">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.92, scaleY: 0.88, scaleX: 1.06 }}
                    transition={{ type: "spring", stiffness: 500, damping: 20 }}
                    className="relative w-full py-3 rounded-full font-black text-sm text-white bg-gradient-to-b from-blue-500 via-[#1877F2] to-blue-800 border border-white/40 shadow-[0_6px_20px_rgba(24,119,242,0.45),inset_0_2px_3px_rgba(255,255,255,0.85),inset_0_-2px_4px_rgba(0,0,0,0.4)] backdrop-blur-md cursor-pointer overflow-hidden group select-none disabled:opacity-50 mt-2 flex items-center justify-center gap-2"
                  >
                    <div className="absolute top-0 inset-x-2 h-[48%] bg-gradient-to-b from-white/75 via-white/25 to-transparent rounded-t-full pointer-events-none" />
                    <motion.div
                      animate={{ x: ['-100%', '100%'] }}
                      ...
                      className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent pointer-events-none"
                    />
                    {isLoading ? <Loader2 className="w-4 h-4 animate-spin text-white relative z-10" /> : <FacebookIcon />}
                    <span className="relative z-10 drop-shadow-xs">{isLoading ? 'កំពុងភ្ជាប់ Facebook...' : 'ចូលប្រើប្រាស់ជាមួយ Facebook Account'}</span>
                  </motion.button>
              ...
              {activeSubModal === 'telegram' && (
                <form onSubmit={handleTelegramDirectSubmit} className="space-y-3.5">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.92, scaleY: 0.88, scaleX: 1.06 }}
                    transition={{ type: "spring", stiffness: 500, damping: 20 }}
                    className="relative w-full py-3 rounded-full font-black text-sm text-white bg-gradient-to-b from-sky-400 via-[#24A1DE] to-sky-700 border border-white/40 shadow-[0_6px_20px_rgba(36,161,222,0.45),inset_0_2px_3px_rgba(255,255,255,0.85),inset_0_-2px_4px_rgba(0,0,0,0.4)] backdrop-blur-md cursor-pointer overflow-hidden group select-none disabled:opacity-50 mt-2 flex items-center justify-center gap-2"
                  >
                    <div className="absolute top-0 inset-x-2 h-[48%] bg-gradient-to-b from-white/75 via-white/25 to-transparent rounded-t-full pointer-events-none" />
                    <motion.div
                      animate={{ x: ['-100%', '100%'] }}
                      ...
                      className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent pointer-events-none"
                    />
                    {isLoading ? <Loader2 className="w-4 h-4 animate-spin text-white relative z-10" /> : <TelegramIcon />}
                    <span className="relative z-10 drop-shadow-xs">{isLoading ? 'កំពុងភ្ជាប់ Telegram...' : 'ចូលប្រើប្រាស់ជាមួយ Telegram Account'}</span>
                  </motion.button>
                  ...
                  <div className="space-y-2 mb-5">
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.92, scaleY: 0.88, scaleX: 1.06 }}
                        transition={{ type: "spring", stiffness: 500, damping: 20 }}
                        className="relative flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-full font-bold text-xs text-slate-800 bg-gradient-to-b from-slate-50 via-white to-slate-100 border border-slate-300/80 shadow-[0_4px_16px_rgba(0,0,0,0.08),inset_0_2px_3px_rgba(255,255,255,0.9),inset_0_-2px_4px_rgba(0,0,0,0.05)] backdrop-blur-md cursor-pointer overflow-hidden group select-none disabled:opacity-50"
                      >
                        <div className="absolute top-0 inset-x-1.5 h-[48%] bg-gradient-to-b from-white/95 via-white/40 to-transparent rounded-t-full pointer-events-none" />
                        <motion.div
                          animate={{ x: ['-100%', '100%'] }}
                          transition={{ repeat: Infinity, duration: 2.8, ease: "easeInOut" }}
                          className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent pointer-events-none"
                        />
                        <GoogleIcon />
                        <span className="relative z-10 font-bold drop-shadow-xs">With Google</span>
                      </motion.button>
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.92, scaleY: 0.88, scaleX: 1.06 }}
                        transition={{ type: "spring", stiffness: 500, damping: 20 }}
                        className="relative flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-full font-bold text-xs text-white bg-gradient-to-b from-indigo-500 via-indigo-600 to-indigo-800 border border-white/40 shadow-[0_4px_16px_rgba(79,70,229,0.4),inset_0_2px_3px_rgba(255,255,255,0.85),inset_0_-2px_4px_rgba(0,0,0,0.4)] backdrop-blur-md cursor-pointer overflow-hidden group select-none disabled:opacity-50"
                      >
                        <div className="absolute top-0 inset-x-1.5 h-[48%] bg-gradient-to-b from-white/75 via-white/25 to-transparent rounded-t-full pointer-events-none" />
                        <motion.div
                          animate={{ x: ['-100%', '100%'] }}
                          transition={{ repeat: Infinity, duration: 2.6, ease: "easeInOut" }}
                          className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent pointer-events-none"
                        />
                        <Mail className="w-4 h-4 text-white relative z-10 drop-shadow-xs" />
                        <span className="relative z-10 font-bold drop-shadow-xs">With Email</span>
                      </motion.button>
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.92, scaleY: 0.88, scaleX: 1.06 }}
                        transition={{ type: "spring", stiffness: 500, damping: 20 }}
                        className="relative flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-full font-bold text-xs text-white bg-gradient-to-b from-blue-500 via-[#1877F2] to-blue-800 border border-white/40 shadow-[0_4px_16px_rgba(24,119,242,0.4),inset_0_2px_3px_rgba(255,255,255,0.85),inset_0_-2px_4px_rgba(0,0,0,0.4)] backdrop-blur-md cursor-pointer overflow-hidden group select-none disabled:opacity-50 shrink-0"
                      >
                        <div className="absolute top-0 inset-x-1.5 h-[48%] bg-gradient-to-b from-white/75 via-white/25 to-transparent rounded-t-full pointer-events-none" />
                        <motion.div
                          animate={{ x: ['-100%', '100%'] }}
                        ...
                        />
                        <FacebookIcon />
                        <span className="relative z-10 font-bold drop-shadow-xs">With Facebook</span>
                      </motion.button>
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.92, scaleY: 0.88, scaleX: 1.06 }}
                        transition={{ type: "spring", stiffness: 500, damping: 20 }}
                        className="relative flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-full font-bold text-xs text-white bg-gradient-to-b from-sky-400 via-[#24A1DE] to-sky-700 border border-white/40 shadow-[0_4px_16px_rgba(36,161,222,0.4),inset_0_2px_3px_rgba(255,255,255,0.85),inset_0_-2px_4px_rgba(0,0,0,0.4)] backdrop-blur-md cursor-pointer overflow-hidden group select-none disabled:opacity-50 shrink-0"
                      >
                        <div className="absolute top-0 inset-x-1.5 h-[48%] bg-gradient-to-b from-white/75 via-white/25 to-transparent rounded-t-full pointer-events-none" />
                        <motion.div
                          animate={{ x: ['-100%', '100%'] }}
                        ...
                        />
                        <TelegramIcon />
                        <span className="relative z-10 font-bold drop-shadow-xs">With Telegram</span>
                      </motion.button>
                    </div>
                  </div>
                  ...
                  {isLoginView ? (
                    ...
                    <form onSubmit={handleLogin} className="space-y-3.5">
                      ...
                      >
                        ...
                        <motion.div
                          ...
                          className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent pointer-events-none"
                        />
                        {isLoading ? <Loader2 className="w-4 h-4 animate-spin text-white relative z-10" /> : <LogIn className="w-4 h-4 text-white relative z-10 drop-shadow-xs" />}
                        <span className="relative z-10 drop-shadow-xs">{isLoading ? 'កំពុងភ្ជាប់ទៅប្រព័ន្ធ...' : 'ចូលប្រើប្រាស់ឥឡូវនេះ'}</span>
                      </motion.button>
                    ...
                    <form onSubmit={handleRegister} className="space-y-3 max-h-[50vh] overflow-y-auto pr-1">
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.92, scaleY: 0.88, scaleX: 1.06 }}
                        transition={{ type: "spring", stiffness: 500, damping: 20 }}
                        className="relative w-full py-3 rounded-full font-black text-sm text-white bg-gradient-to-b from-emerald-500 via-emerald-600 to-emerald-800 border border-white/40 shadow-[0_6px_20px_rgba(16,185,129,0.45),inset_0_2px_3px_rgba(255,255,255,0.85),inset_0_-2px_4px_rgba(0,0,0,0.4)] backdrop-blur-md cursor-pointer overflow-hidden group select-none disabled:opacity-50 mt-2 flex items-center justify-center gap-2"
                      >
                        <div className="absolute top-0 inset-x-2 h-[48%] bg-gradient-to-b from-white/75 via-white/25 to-transparent rounded-t-full pointer-events-none" />
                        <motion.div
                          animate={{ x: ['-100%', '100%'] }}
                          ...
                          className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent pointer-events-none"
                        />
                        {isLoading ? <Loader2 className="w-4 h-4 animate-spin text-white relative z-10" /> : <UserPlus className="w-4 h-4 text-white relative z-10 drop-shadow-xs" />}
                        <span className="relative z-10 drop-shadow-xs">{isLoading ? 'កំពុងបង្កើតគណនី...' : 'ចុះឈ្មោះគ្រូ និងចូលប្រើ'}</span>
                      </motion.button>
